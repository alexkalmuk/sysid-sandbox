...
fprintf('\n');
fprintf(['System:\n',...
        'y_{t+1} + %.01f * y_t + %01.f * y_{t−1} = %.01f * u_t + %.01f * u_{t−1} + w_t\n',...
        '  a1=%.01f and b1=%0.01f are unknown\n',...
        '  %.01f <= w_t <= %.01f (mu,sigma = %d, %d)\n', ...
        'Emulation time: %d\n',...
        'Initial state: y_1 = %.01f, y_2 = %.01f\n',...
        'Uncertainties set: [%.01f %.01f; %.01f %.01f]\n',...
        'Control constraints: %.01f <= u <= %.01f\n',...
        'State constraints: %.01f <= y <= %.01f\n',...
        'RMPC:\n',...
        '  MPC horizon: %d\n',...
        '  Scenarios: %d\n',...
        ],...
        a1, a2, b1, b2,...
        a1, b1,...
        Omega_W(1), Omega_W(2) ,mu, sigma,...
        T,...
        y(1), y(2),...
        Omega_AB{1}(1,1),Omega_AB{1}(1,2),Omega_AB{1}(2,1),Omega_AB{1}(2,2),...
        C_u(1), C_u(2),...
        C_y(1), C_y(2),...
        N_mpc,...
        M_mpc);
